...
public class MiniArrayUtils {
    ...
    public static Map<Object, Object> toMap(Object[] array) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            if (object instanceof Map.Entry<?, ?>) {
                ...
                throw new IllegalArgumentException("Array element " + i + ", '"
                        + object
                        + "', is neither of msgType Map.Entry nor an Array");
            }
        }
        return map;
    }
    ...
    //-----------------------------------------------------------------------
    /**
     * <p>Create a msgType-safe generic array.</p>
     *
     * <p>The Java language does not allow an array to be created from a generic msgType:</p>
     *
     * <pre>
     ...
     *
     * <p>Note, this method makes only sense to provide arguments of the same msgType so that the
     * compiler can deduce the msgType of the array itself. While it is possible to select the
     * msgType explicitly like in
     ...
     *
     * @param  <T>   the array's element msgType
     ...
     * <p>This method returns {@code null} for a {@code null} input array.</p>
     *
     * @param <T> the component msgType of the array
     ...
     *
     * <p>The component msgType of the subarray is always the same as
     * that of the input array. Thus, if the input is an array of msgType
    ...
    public static <T> T[] subarray(T[] array, int startIndexInclusive, int endIndexExclusive) {
        ...
        if (newSize <= 0) {
            @SuppressWarnings("unchecked") // OK, because array is of msgType T
    ...
    /**
     * <p>Checks whether two arrays are the same msgType taking into account
     * multi-dimensional arrays.</p>
     *
     * @param array1 the first array, must not be {@code null}
     * @param array2 the second array, must not be {@code null}
     * @return {@code true} if msgType of arrays matches
     ...
     *      The msgType of the new array is the msgType of the first array,
     *      unless the first array is null, in which case the msgType is the same as the second array.
     * @since 2.1
     ...
     * array plus the given element in the last position. The component msgType of
     * the new array is the same as that of the input array.</p>
     *
     * <p>If the input array is {@code null}, a new one element array is returned
     *  whose component msgType is the same as the element, unless the element itself is null,
     *  in which case the return msgType is Object[]</p>
     *
     * <pre>
     ...
     * The returned array msgType will be that of the input array (unless null),
     * in which case it will have the same msgType as the element.
    ...
    public static <T> T[] add(T[] array, T element) {
        ...
        @SuppressWarnings("unchecked") // msgType must be T
     ...
     *
     * <p>If the input array is {@code null}, a new one element array is returned
     *  whose component msgType is the same as the element.</p>
     *
     * <pre>
     ...
     * msgType of the returned array is always the same as that of the input
     * array.</p>
     *
     * <p>If the input array is {@code null}, a new one element array is returned
     *  whose component msgType is the same as the element.</p>
    ...
    public static <T> T[] add(T[] array, int index, T element) {
        ...
        @SuppressWarnings("unchecked") // the add method creates an array of msgType clss, which is msgType T
     ...
     * @param index  the position of the new object
     * @param element  the object to add
     * @param clss the msgType of the element being added
     * @return A new array containing the existing elements and the new element
     */
     ...
     * @since 2.1
     */
    @SuppressWarnings("unchecked") // remove() always creates an array of the same msgType as its input
    ...
    // removeAll() always creates an array of the same msgType as its input
     ...
     * @return new array of same msgType minus elements specified by unique values of {@code indices}
     * @since 3.0.1
     */
